...
namespace StudentDetails.Controllers
{
    public class StudentsController : Controller
    {
        public ActionResult Index()
        {
            ...
            {
                webClient.BaseAddress = "https://localhost:44390/api/";
        ...
        public ActionResult Delete(int id, StudDetails model)
        {
            ...
            try
            {
                using (WebClient webClient = new WebClient())
                {
                    ...
                    string url = "https://localhost:44390/api/Students/" + id;
        ...
        public ActionResult Edit(int id, StudDetails model)
        {
            ...
            try
            {
                using (WebClient webClient = new WebClient())
                {
                    webClient.BaseAddress = "https://localhost:44390/api/Students/" + id;
